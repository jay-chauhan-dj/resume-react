...
import icon1 from '../../images/icon/nodejs.svg'
import icon2 from '../../images/icon/reactjs.svg'
import icon3 from '../../images/icon/laravel.svg'
    ...
    return (
        <section className="static-hero bg-[#131313] h-[940px] xl:h-[900px] lg:h-[650px] md:h-[950px] sm:h-[890px] col:h-[800px]  relative z-40 overflow-hidden">
                    ...
                    <div className="flex-1">
                        <div className="w-[660px] lg:w-[470px]  md:w-full  md:text-center">
                            <h2 className="text-white text-[90px] capitalize font-bold leading-[100px] mb-[10px]  lg:text-[65px] lg:mb-[10px] lg:leading-[75px] md:text-[45px] md:leading-[45px]  col:text-[35px] col:leading-[35px] col:mb-[0px]">
                                ...
                                I am { hero.name }.</h2>
                            <h5 className="text-[#59C378] text-[32px] capitalize font-semibold leading-[39px] mb-[20px] lg:text-[28px] md:text-[22px] md:mb-[10px] col:text-[20px]  col:mb-[5px]">{ hero.title }</h5>
                            <p className="text-white text-[19px] capitalize font-normal leading-[33px] mb-[30px] col:text-[15px] col:leading-[28px] md:mx-[80px] text-justify col:mx-0">{ hero.description }</p>
                            <div className="slide-btn"><Link className="theme-btn" to="contact" spy={true} smooth={true} duration={500}>{ hero.contactButtonText }</Link></div>
                        </div>
                    </div>
                </div>
            </div>
            <div className="absolute top-[53%] rounded-[50%] right-[200px] z-10 transform -translate-y-1/2 2xl:max-w-[500px] lg:max-w-[450px]  lg:top-[54%] 2xl:right-[80px] xl:right-[30px] lg:right-[50px] md:top-[74%] md:mx-auto md:right-auto md:left-1/2 md:-translate-x-1/2 sm:top-[75%] sm:w-[400px] sm:h-[400px] sm:left-1/2 sm:m-0 col:top-[75%] col:w-[300px] col:h-[300px]">
                <img className="rounded-[50%]" src={ hero.mainImage.src } alt={ hero.mainImage.altText }/>
                    ...
                    <div className="absolute left-0 bottom-[5%] bg-white  rounded-[40px] py-[0] px-[20px]  flex items-center floating-item">
                        ...
                        <div className="p-text">
                            <h3 className="text-[25px] mb-0 text-[#202020] col:text-[20px]"><span className="odometer" data-count={ hero.completedProjects }>{ hero.completedProjects }</span>+</h3>
